...
class Userdata(models.Model):
	...
	Profileimage=models.ImageField(upload_to='userimage',blank=True,null=True,default="userimage/user.png");
...
def create_slug(instance,new_slug=None):
	...
	if new_slug is not None:
		slug=new_slug;
	qs=PostArtical.objects.filter(slug=slug).order_by('-id');
	exists=qs.exists();
	if exists:
...
pre_save.connect(pre_save_receiver,sender=PostArtical);
